...
ACCESS_TOKEN = os.getenv("LINE_ACCESS_TOKEN", "Tt5s/Qw2fClISbFObetqkySpbH4ZGEndu1sY5P8+FSpzrER6XKPV1LIDwkeyIcCwrWt7/lKkwBV1H4xD6Iv0vUYO9IXT5AHNQjUjEnNbTNG5zYQ2f+LNJSYKLRacDeyEuYuTVdZ6Gx4c6JbHmWNh2QdB04t89/1O/w1cDnyilFU=")
CHANNEL_SECRET = os.getenv("LINE_CHANNEL_SECRET", "84f0456940faa4afd2cded1759c677ca")

# ข้อมูล Gemini api key
GEMINI_API_KEY = os.getenv("GEMINI_API_KEY", "AIzaSyB4cKzsdEMPOUWGAYgpiUKRTNQn6CCwb4g")
...
async def lifespan(app: FastAPI):
    ...
    sample_documents = [
        "นายพลทัต แซ่ตั้ง คือ ชายหนุ่มวัยเยาว์ที่มีความสามารถในการเขียนโปรแกรมภาษา Python, C++ ที่มาจากมหาวิทยาลัยบูรพา คณะวิทยาการสารสนเทศ สาขา AAI ที่เป็นสาขาเปิดใหม่โดยสอนหลักสูตรเกี่ยวกับ AI/ML, Robotic, Database",
        "นายพลทัต แซ่ตั้ง มีชื่อเล่นว่า บอย เกิดวันที่ 21 กรกฏาคม 2546 ที่จังหวัดฉะเชิงเทรา กำลังศึกษาอยู่ที่มหาวิทยาลัยบูรพา สาขา AAI",
        "งาน BUU-ai-Bootcamp-2024 จัดที่มหาวิทยาลัยบูรพา ในวันที่ 12 ธันวาคม ปีค.ศ.2024 โดยมีการจัดกิจกรรมต่าง ๆ ที่เกี่ยวข้องกับการพัฒนาซอฟต์แวร์โดยจะเป็นการใช้ศาสตร์ AI ในด้าน NLP เป็นหลักและนำโมเดลที่พัฒนามาใช้กับแอพลิเคชั่น เวลา 8:30 น. - 16:00 น. จำนวนผู้เข้าร่วมไม่แน่นอนเพราะมีนิสิตที่สนใจมาเพิ่ม",
        "มหาวิทยาลัยบูรพา สาขาวิชาAI ปีการศึกษา 2565 มีนักศึกษาจำนวน 100 คน มีอาจารย์ที่ปรึกษา 10 คน",
        "Team AI ของบริษัท Clicknext มีสมาชิกดังนี้ 1.พี่ออย ทำงานตำแหน่ง BA ,2.พี่ดาวเป็นคนที่จำง่ายเพราะการแนะนำตัวของพี่เขามาจาก AI รุ่น 1 ทำงานตำแหน่ง BA, 3.จิรภัทร ทำดี มีชื่อเล่นว่า ปาล์ม BackendDev ,4.พี่เจ๋ง Teerapong Saisrikaew ทำงานตำแหน่ง FrontDev ,5.พี่ชวน ตำแหน่ง DataOps ",
        "ทำไมข้อมูลถึงมีได้แค่นี้? เพราะว่าข้อมูลของทุกคนนั้นเป็นส่วนตัวไม่ได้มีการบันทึกใน public data"
    ]
